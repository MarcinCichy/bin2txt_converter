...
class Application(Frame):
    ...
    def create_widgets(self):
        frm_txtField_Frame = Frame(self, bg = 'blue')  # , bg = 'blue'
        frm_txtField_Frame.grid(row=0, column=0,  ipadx=5, ipady=5, sticky=NW)
        frm_RadioButtons_Frame = Frame(self, bg = 'red')  # , bg = 'red'
        frm_RadioButtons_Frame.grid(row=0, column=1, ipadx=5, ipady=5, sticky=NW)
        frm_Buttons_Frame = Frame(self, bg='green')  # , bg = 'green'
        frm_Buttons_Frame.grid(row=0, column=1, ipadx=5, ipady=5, sticky=NW)
        
        self.txt_enterField_1 = Text(frm_txtField_Frame, width=80, height=15)  # ,width = 100, height = 100
        self.txt_enterField_1.grid(row=1, column=0, padx=2, pady=10, sticky=NE)
        self.txt_enterField_2 = Text(frm_txtField_Frame, width=80, height=15)  # ,width = 100, height = 100
        ...
        self.btn_Convert.grid(row=0, column=0, padx=5, pady=5, sticky=NW)
        self.btn_Flip = Button(frm_Buttons_Frame)
        self.btn_Flip['text'] = 'Flip'
        self.btn_Flip['command'] = self.flip
        self.btn_Flip.grid(row=1, column=0, padx=5, pady=5, sticky=NW)
